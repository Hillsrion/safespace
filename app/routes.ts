...
export default [
  ...
  layout(layoutPath("api.tsx"), [
    ...prefix(RESOURCES_API_PREFIX, [
      ...
      route(`admin/spaces/:spaceId/reported-entities`, routePath("api/admin/spaces/:spaceId/reported-entities.ts")),
      route(`admin/spaces/:spaceId/reported-entities/:entityId`, routePath("api/admin/spaces/:spaceId/reported-entities/:entityId.ts")),
      route(`admin/spaces/:spaceId/reported-entities/:entityId/handles/:handleId/review`, routePath("api/admin/spaces/:spaceId/reported-entities/:entityId/handles/:handleId/review.ts")),
      route(`admin/spaces/:spaceId/posts/:postId/moderate`, routePath("api/admin/spaces/:spaceId/posts/:postId/moderate.ts")),
      route(`admin/spaces/:spaceId/posts/flagged`, routePath("api/admin/spaces/:spaceId/posts/flagged.ts")),
      route(`admin/spaces/:spaceId/invites`, routePath("api/admin/spaces/:spaceId/invites.ts")),
